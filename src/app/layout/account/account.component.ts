...
import { Administrator, AdministratorService, DateUtils, SessionUtils, AccountDetails, AccountService } from 'src/app/shared';
    ...
    save() {
        ...
        this.accountService.update(this.sessionUtils.getRole(), this.account)
            .subscribe(result => {
                    ...
                    this.toastr.success('Refreshing page...', 'Success');
